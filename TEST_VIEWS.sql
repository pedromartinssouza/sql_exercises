...
DO $$
    ...
    BEGIN
        ...
        /* TESTE 1A - CHECA QUANTIDADE DE REGISTROS EM VIEW VENDAS_MENSAIS - ESPERA 3 */
        BEGIN
        ...
        /* TESTE 1B - CHECA VALOR TOTAL DE VENDAS IDCAR - ESPERA 160.0 */
        BEGIN
        ...
        /* TESTE 1C - CHECA VALOR TOTAL, QUANTIDADE VENDIDA E NOME COM IDPED/2022-01 - ESPERA 30.0, 3.0 E PEDRO */
        BEGIN
        ...
        /* TESTE 1D - CHECA VALOR TOTAL, QUANTIDADE VENDIDA E NOME COM IDCAR/2020-01 - ESPERA 160.0, 6.0 E CARLOS */
        BEGIN
            SELECT NOME, QUANTIDADE_VENDIDA, VALOR_TOTAL INTO V_NOME, V_QUANTIDADE_VENDIDA, V_VALOR_TOTAL
        ...
        /* TESTE 1E - CHECA VALOR TOTAL, QUANTIDADE VENDIDA E NOME COM IDPED/2020-01 - ESPERA 100.0, 5.0 E PEDRO */
        BEGIN
            SELECT NOME, QUANTIDADE_VENDIDA, VALOR_TOTAL INTO V_NOME, V_QUANTIDADE_VENDIDA, V_VALOR_TOTAL
...
DO $$
    ...
    BEGIN
        ...
        /* TESTE 2A - CHECA QUANTIDADE DE REGISTROS EM VIEW VENDAS_SUMARIZADAS - ESPERA 5 */
        BEGIN
        ...
        /* TESTE 2B - CHECA VALOR TOTAL, LISTA DE PRODUTOS, NOME DO VENDEDOR E NOME DO COMPRADOR NA VENDA 1 - ESPERA 130.0, 'ARGILA,CONCRE', CARLOS E GUSTAVO */
        BEGIN
        ...
        /* TESTE 2C - CHECA VALOR TOTAL, LISTA DE PRODUTOS, NOME DO VENDEDOR E NOME DO COMPRADOR NA VENDA 1 APOS REMOVER TRANSACAO - ESPERA 130.0, 'CONCRE', CARLOS E GUSTAVO */
        BEGIN
        ...
        /* TESTE 2D - CHECA VALOR TOTAL, LISTA DE PRODUTOS, NOME DO VENDEDOR E NOME DO COMPRADOR NA VENDA 2 - ESPERA 30.0, 'CONCRE', CARLOS E GUSTAVO */
        BEGIN
            SELECT VALOR_TOTAL, PRODUTOS, NOME_VENDEDOR, NOME_COMPRADOR 
            INTO V_VALOR_TOTAL, V_PRODUTOS, V_NOME_VENDEDOR, V_NOME_COMPRADOR 
        ...
        /* TESTE 2E - CHECA VALOR TOTAL, LISTA DE PRODUTOS, NOME DO VENDEDOR E NOME DO COMPRADOR NA VENDA 3 - ESPERA 20.0, 'CIMENT', PEDRO E SOR */
        BEGIN
            SELECT VALOR_TOTAL, PRODUTOS, NOME_VENDEDOR, NOME_COMPRADOR 
            INTO V_VALOR_TOTAL, V_PRODUTOS, V_NOME_VENDEDOR, V_NOME_COMPRADOR 
        ...
        /* TESTE 2F - CHECA VALOR TOTAL, LISTA DE PRODUTOS, NOME DO VENDEDOR E NOME DO COMPRADOR NA VENDA 4 - ESPERA 80.0, 'CIMENT', PEDRO E LORENZO */
        BEGIN
            SELECT VALOR_TOTAL, PRODUTOS, NOME_VENDEDOR, NOME_COMPRADOR 
            INTO V_VALOR_TOTAL, V_PRODUTOS, V_NOME_VENDEDOR, V_NOME_COMPRADOR 
        ...
        /* TESTE 2G - CHECA VALOR TOTAL, LISTA DE PRODUTOS, NOME DO VENDEDOR E NOME DO COMPRADOR NA VENDA 5 - ESPERA 30.0, 'ARGILA', PEDRO E SOR */
        BEGIN
            SELECT VALOR_TOTAL, PRODUTOS, NOME_VENDEDOR, NOME_COMPRADOR 
            INTO V_VALOR_TOTAL, V_PRODUTOS, V_NOME_VENDEDOR, V_NOME_COMPRADOR 
...
DO $$
    ...
    BEGIN
        ...
        /* TESTE 3A - CHECA QUANTIDADE DE REGISTROS EM VIEW ESTOQUE_DISPONIVEL - ESPERA 3 */
        BEGIN
        ...
        /* TESTE 3B - CHECA ESTOQUE DISPONIVEL PARA ARGILA - ESPERA 97 */
        BEGIN
        ...
        /* TESTE 3C - CHECA ESTOQUE DISPONIVEL PARA CIMENT - ESPERA 95 */
        BEGIN
        ...
        /* TESTE 3D - CHECA ESTOQUE DISPONIVEL PARA CONCRE - ESPERA 95 */
        BEGIN
